    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navtoggleid">
            <ul class="navbar-nav ml-auto" style="z-index: 10 !important;">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/" style="color: #17223E">About</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/" style="color: #17223E">Contact</a>
                </li>
...
<section class="contact-us py-100" id="contact">
    <div class="container">
        <div class="row">
            <h1>Your Loan request is being processed. We will get back to you as soon as possible</h1>
        </div>
    </div>
</section>
